...
// Default storefront catalog — rendered for every store that has no custom
// catalog in CATALOG_PAGE_CONFIG (see pages/store/CatalogPage.tsx).
            ...
            {(products) => {
              return products.map((product) => {
                return (
                  <div
                    key={product.id}
                    className="w-full min-w-0 flex justify-center md:w-auto md:shrink-0"
                  >
