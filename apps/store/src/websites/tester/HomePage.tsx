...
/**
 * Dev-preview storefront home (tester_store) — base copy of the balasistore
 * home so `dev:test` renders a real, themed storefront to migrate against.
 * Diverges from balasistore as we port the new Balasi design section by section.
 */
