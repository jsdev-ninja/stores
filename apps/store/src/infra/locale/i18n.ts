	...
	he: {
		...
		common: {
			...
			inventoryCertificatePage: {
				...
				newProductBadge: "מוצר חדש",
				newProductHint: "לא קיים בקטלוג — יש להוסיף בהוספת מוצר",
				existingProductBadge: "קיים בקטלוג",
				newProductsWarning_one: "מוצר חדש אחד אינו קיים בקטלוג. יש להוסיף אותו דרך 'הוספת מוצר' כדי שיופיע באתר.",
				newProductsWarning_other: "{{count}} מוצרים חדשים אינם קיימים בקטלוג. יש להוסיף אותם דרך 'הוספת מוצר' כדי שיופיעו באתר.",
				newProductsModalTitle: "מוצרים חדשים שיש להוסיף לקטלוג",
			},
