...
export const resources = {
	he: {
		...
		common: {
			...
			view: "צפה",
			dashboard: "לוח בקרה",
			// Admin sidebar navigation labels (dedicated so they don't affect
			// the generic labels used elsewhere in the app).
			nav: {
				dashboard: "דשבורד",
				orders: "הזמנות",
				organizations: "חברות",
				...
				invoices: "הפקת חשבוניות",
				customerInvoices: "חשבוניות לקוחות",
				budget: "חובות לקוחות",
				settings: "הגדרות",
				logout: "יציאה",
				problemOrders: "בעיות בהזמנות",
			},
			...
			inventoryCertificatePage: {
				...
				searchPlaceholder: "חיפוש לפי ספק או מספר חשבונית",
				filterBySupplier: "כל הספקים",
				dateFrom: "מתאריך",
				dateTo: "עד תאריך",
				clearFilters: "נקה סינון",
				noMatchingInvoices: "לא נמצאו חשבוניות התואמות לסינון",
				draftsTab: "טיוטות",
				...
				newProductsTitle: "מוצרים חדשים שלא קיימים במערכת (צריך להכניס):",
			},
		...
		auth: {
			...
			form: {
				...
				forgotPassword: {
					link: "שכחת סיסמה?",
					title: "איפוס סיסמה",
					description: "הכנס את כתובת האימייל שלך ונשלח אליך קישור לאיפוס הסיסמה.",
					submit: "שלח קישור לאיפוס",
					success: "אם קיים חשבון עם כתובת אימייל זו, נשלח אליו קישור לאיפוס הסיסמה. בדוק את תיבת הדואר שלך.",
		...
		orderErrorPage: {
			...
			description:
				"אירעה שגיאה בעיבוד התשלום. ההזמנה שלך נשמרה במערכת ומנהל החנות קיבל התראה. ניצור איתך קשר בהקדם להשלמת התשלום.",
			orderId: "מזהה הזמנה",
		...
		problemOrdersPage: {
			...
			summary: {
				total: "סה״כ הזמנות",
				withProblems: "הזמנות עם בעיות",
				clean: "הזמנות תקינות",
				g1Count: "סטטוס לא הושלם",
				g2Count: "תשלום לא הושלם",
				g3Count: "חסר מסמך",
			},
			filters: {
				all: "הכל",
			...
			emptyState: "אין הזמנות עם בעיות",
			searchPlaceholder: "חיפוש לפי מזהה הזמנה / לקוח...",
			actions: {
				viewDetails: "פרטים",
				refresh: "רענן",
			...
			aria: {
				hasInvoice: "יש חשבונית",
				noInvoice: "אין חשבונית",
				hasDeliveryNote: "יש תעודת משלוח",
				noDeliveryNote: "אין תעודת משלוח",
			},
		},
		store: {},
		admin: {
			budget: {
				title: "ניהול תקציב",
				noAccounts: "אין חובות פתוחים",
				totalDebits: "סה״כ חיובים",
				totalCredits: "סה״כ תשלומים",
				balance: "יתרת חוב",
				addManual: "הוסף תנועה ידנית",
				txType: "סוג תנועה",
				amount: "סכום",
				runningBalance: "יתרה",
			...
			productsPage: {
				...
				tabWithoutPurchasePrice: "ללא מחיר רכישה",
