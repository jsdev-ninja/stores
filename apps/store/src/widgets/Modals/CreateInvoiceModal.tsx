...
function FormContent({
	...
	useEffect(() => {
		if (organizationId && billingAccount) {
			...
			const hasBillingAccount = selectedOrg?.billingAccounts.some(
				(acc) => acc.number === billingAccount
			);
	...
	return (
		<>
				...
				<div className="flex flex-col gap-2">
					...
					<div className="relative">
						<Icon
							...
							className="absolute left-3 top-1/2 -translate-y-1/2 text-default-400 pointer-events-none z-10"
						/>
						<Select
			...
			<Modal.Footer>
				...
				<Button type="submit" variant="primary" isPending={isLoadingOrders}>
...
export function CreateInvoiceModal({
	...
	onOrdersFound?: (orders: TOrder[]) => void;
}) {
