...
export { deleteClient, migrateProfilesToMultiOrg } from "./modules/customers";
...
export { onOrderUpdate, onTransactionPostedMarkOrderPaid, createOrder, updateOrder } from "./modules/orders";
